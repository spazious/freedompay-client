...
import freedompay_client.models
from freedompay_client import rest
from freedompay_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(freedompay_client.models, klass)
