...
class TORService(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TORService:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TORService:
        """Create an instance of TORService from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TORService.parse_obj(obj)

        _obj = TORService.parse_obj({
            "run": obj.get("run")
        })
        return _obj
