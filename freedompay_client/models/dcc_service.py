...
class DccService(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DccService:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DccService:
        """Create an instance of DccService from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DccService.parse_obj(obj)

        _obj = DccService.parse_obj({
            "bin": obj.get("bin"),
