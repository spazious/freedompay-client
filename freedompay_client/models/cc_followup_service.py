...
class CCFollowupService(BaseModel):
    """
    CCFollowupService
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CCFollowupService:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CCFollowupService:
        """Create an instance of CCFollowupService from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CCFollowupService.parse_obj(obj)

        _obj = CCFollowupService.parse_obj({
            "run": obj.get("run")
        })
        return _obj
