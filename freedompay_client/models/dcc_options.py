...
class DccOptions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DccOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DccOptions:
        """Create an instance of DccOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DccOptions.parse_obj(obj)

        _obj = DccOptions.parse_obj({
