...
class MessageService(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MessageService:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MessageService:
        """Create an instance of MessageService from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MessageService.parse_obj(obj)

        _obj = MessageService.parse_obj({
            "run": obj.get("run")
        })
        return _obj
