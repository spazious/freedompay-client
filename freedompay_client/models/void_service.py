...
class VoidService(BaseModel):
    ...
    __properties = ["reason", "offline", "offlineCode", "run"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VoidService:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VoidService:
        """Create an instance of VoidService from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VoidService.parse_obj(obj)

        _obj = VoidService.parse_obj({
