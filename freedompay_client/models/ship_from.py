...
class ShipFrom(BaseModel):
    ...
    __properties = ["company", "title", "firstName", "middleName", "lastName", "suffix", "street1", "street2", "street3", "street4", "city", "state", "postalCode", "country", "phoneNumber", "faxNumber", "email", "ssn"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ShipFrom:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ShipFrom:
        """Create an instance of ShipFrom from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ShipFrom.parse_obj(obj)

        _obj = ShipFrom.parse_obj({
