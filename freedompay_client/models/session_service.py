...
class SessionService(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SessionService:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SessionService:
        """Create an instance of SessionService from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SessionService.parse_obj(obj)

        _obj = SessionService.parse_obj({
            "run": obj.get("run")
        })
        return _obj
