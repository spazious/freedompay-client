...
class KountOptions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> KountOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> KountOptions:
        """Create an instance of KountOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return KountOptions.parse_obj(obj)

        _obj = KountOptions.parse_obj({
