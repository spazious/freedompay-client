...
class EodService(BaseModel):
    """
    EodService
    """
    level: Optional[StrictStr] = None
    group_code: Optional[StrictStr] = Field(None, alias="groupCode")
    run: Optional[StrictStr] = None
    __properties = ["level", "groupCode", "run"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EodService:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EodService:
        """Create an instance of EodService from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EodService.parse_obj(obj)

        _obj = EodService.parse_obj({
            "level": obj.get("level"),
