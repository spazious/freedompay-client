...
class ButtonControl(BaseModel):
    ...
    ButtonControl
    """
    integrated: Optional[StrictBool] = Field(None, alias="Integrated")
    __properties = ["Integrated"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ButtonControl:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ButtonControl:
        """Create an instance of ButtonControl from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ButtonControl.parse_obj(obj)

        _obj = ButtonControl.parse_obj({
            "integrated": obj.get("Integrated")
        })
        return _obj
