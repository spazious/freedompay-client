...
class RequestIncentives(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RequestIncentives:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RequestIncentives:
        """Create an instance of RequestIncentives from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RequestIncentives.parse_obj(obj)

        _obj = RequestIncentives.parse_obj({
