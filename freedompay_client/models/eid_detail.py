...
class EIDDetail(BaseModel):
    """
    EIDDetail
    """
    discount_key: Optional[StrictStr] = Field(None, alias="discountKey")
    ...
    __properties = ["discountKey", "code", "qty", "offset", "totalAmount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EIDDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EIDDetail:
        """Create an instance of EIDDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EIDDetail.parse_obj(obj)

        _obj = EIDDetail.parse_obj({
            "discount_key": obj.get("discountKey"),
            "code": obj.get("code"),
            "qty": obj.get("qty"),
