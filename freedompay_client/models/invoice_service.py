...
class InvoiceService(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvoiceService:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvoiceService:
        """Create an instance of InvoiceService from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvoiceService.parse_obj(obj)

        _obj = InvoiceService.parse_obj({
