...
class PostalCodeControl(BaseModel):
    """
    PostalCodeControl
    """
    ...
    def placeholder_type_validate_enum(cls, value):
        ...
        if value not in ('Unknown', 'Blank', 'Default', 'EnterPostalCode'):
            raise ValueError("must be one of enum values ('Unknown', 'Blank', 'Default', 'EnterPostalCode')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostalCodeControl:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostalCodeControl:
        """Create an instance of PostalCodeControl from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostalCodeControl.parse_obj(obj)

        _obj = PostalCodeControl.parse_obj({
