...
class VendProductList(BaseModel):
    """
    VendProductList
    """
    product: Optional[conlist(VendProduct)] = None
    options: Optional[StrictStr] = None
    __properties = ["product", "options"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VendProductList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VendProductList:
        """Create an instance of VendProductList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VendProductList.parse_obj(obj)

        _obj = VendProductList.parse_obj({
            "product": [VendProduct.from_dict(_item) for _item in obj.get("product")] if obj.get("product") is not None else None,
