...
class TokenInformation(BaseModel):
    ...
    __properties = ["Token", "ExpirationMonth", "ExpirationYear"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokenInformation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokenInformation:
        """Create an instance of TokenInformation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokenInformation.parse_obj(obj)

        _obj = TokenInformation.parse_obj({
            "token": obj.get("Token"),
