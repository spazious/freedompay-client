...
class UserDefinedField(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserDefinedField:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserDefinedField:
        """Create an instance of UserDefinedField from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserDefinedField.parse_obj(obj)

        _obj = UserDefinedField.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value")
        })
        return _obj
