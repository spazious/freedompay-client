...
class CardNumberControl(
            ...
            class PlaceholderType(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        ...
                        "Blank": "BLANK",
                        "Default": "DEFAULT",
                        "EnterCardNumber": "ENTER_CARD_NUMBER",
                    }
                ...
                @schemas.classproperty
                def ENTER_CARD_NUMBER(cls):
                    return cls("EnterCardNumber")
            __annotations__ = {
                "LabelType": LabelType,
                "MaskType": MaskType,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["LabelType", "MaskType", "PlaceholderType", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["LabelType", "MaskType", "PlaceholderType", ], str]):
